...
//
//Two envelopes, selected by the STICKY CONTROL INTERRUPT key (fza_sfmplus_kbStickyInterupt -
...
//(fza_sfmplus_accelX/Y - the smoothed derivative of the very velocity the loop nulls, so it is
...
//Altitude is blended against the RAW radar altitude from fza_sfmplus_fnc_getAltitude (3rd return):
