...
switch (_inputAxis) do {
    ...
    case "collective" : {
        private _prevLagInput  = _heli getVariable "fza_sfmplus_prevLagInputColl";
        private _prevLagOutput = _heli getVariable "fza_sfmplus_prevLagOutputColl";
        ...
        _heli setVariable ["fza_sfmplus_prevLagInputColl",  _input];
        _heli setVariable ["fza_sfmplus_prevLagOutputColl", _output];
    };
};
