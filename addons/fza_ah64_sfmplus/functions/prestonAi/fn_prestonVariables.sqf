/* ----------------------------------------------------------------------------
Function: fza_sfmplus_fnc_prestonVariables
...
_heli setVariable ["fza_sfmplus_pid_prestonPitch",      [0.1200, 0.0200, 0.1000, 5.0000] call fza_fnc_pidCreate];
(_heli getVariable "fza_sfmplus_pid_prestonPitch") set ["dCoef", 0.5];
_heli setVariable ["fza_sfmplus_prestonPitchActive",    false];
_heli setVariable ["fza_sfmplus_prestonPitchTarget",    -6.0];
...
_heli setVariable ["fza_sfmplus_pid_prestonRoll",       [0.0700, 0.0200, 0.0900, 5.0000] call fza_fnc_pidCreate];
(_heli getVariable "fza_sfmplus_pid_prestonRoll") set ["dCoef", 0.5];
_heli setVariable ["fza_sfmplus_prestonRollActive",     false];
_heli setVariable ["fza_sfmplus_prestonRollTarget",     0.0];
...
_heli setVariable ["fza_sfmplus_pid_prestonHoverX",     [0.0600, 0.2200, 0.0500, 0.2500] call fza_fnc_pidCreate];
_heli setVariable ["fza_sfmplus_pid_prestonHoverY",     [0.0700, 0.2500, 0.0600, 0.5500] call fza_fnc_pidCreate];
(_heli getVariable "fza_sfmplus_pid_prestonHoverX") set ["dCoef", 0.5];
(_heli getVariable "fza_sfmplus_pid_prestonHoverY") set ["dCoef", 0.5];
...
_heli setVariable ["fza_sfmplus_pid_prestonVelX",       [0.0500, 0.0400, 0.1000, 1.0000] call fza_fnc_pidCreate];
_heli setVariable ["fza_sfmplus_pid_prestonVelY",       [0.1000, 0.0200, 0.1200, 1.0000] call fza_fnc_pidCreate];
(_heli getVariable "fza_sfmplus_pid_prestonVelX") set ["dCoef", 0.5];
(_heli getVariable "fza_sfmplus_pid_prestonVelY") set ["dCoef", 0.5];
_heli setVariable ["fza_sfmplus_prestonVelCmdFwd",      0.0];   //commanded forward velocity (m/s)
...
_heli setVariable ["fza_sfmplus_prestonPrevPitch",      0.0];
_heli setVariable ["fza_sfmplus_prestonPrevRoll",       0.0];
_heli setVariable ["fza_sfmplus_prestonBreakout",       false];
_heli setVariable ["fza_sfmplus_prestonHoverDatum",     getPos _heli];  //world-space position datum
_heli setVariable ["fza_sfmplus_prestonHoverIntX",      0.0];           //position-error integral (right)
_heli setVariable ["fza_sfmplus_prestonHoverIntY",      0.0];           //position-error integral (fwd)
...
_heli setVariable ["fza_sfmplus_prestonLearnedIntX",    0.0];
_heli setVariable ["fza_sfmplus_prestonLearnedIntY",    0.5500];
