...
fza_ah64_eachFrameArray   = [fza_mpd_fnc_update, fza_ihadss_fnc_fovControl, bmkhs_fnc_systemsUpdate, fza_hellfire_fnc_aceController, fza_light_fnc_controller, fza_ah64_helisim_fnc_perFrame, fza_anim_fnc_animationUpdate];
