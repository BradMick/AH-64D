...
[_heli, "bmkhs_randomTq", 1, _randomTq, true] call bmkhs_fnc_setArrayVariable;

if (_grbxHitPtDmg == 1.0) then {
    _engOverspeed = true;
    [_heli, "bmkhs_engineOverspeed", 1, _engOverspeed, false] call bmkhs_fnc_setArrayVariable;
};
