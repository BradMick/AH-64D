/* ----------------------------------------------------------------------------
Function: bmkhs_fnc_electricalBattery
...
if (local _heli) then {
    [_heli, "bmkhs_battBusOn", _battBusOn] call bmkhs_fnc_utilUpdateNetworkGlobal;
};
...
_heli setVariable ["bmkhs_battPower_pct", _battPower];
