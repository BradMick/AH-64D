...
hintsilent format ["v0.11
                    ...
                    \nEng FF = %12
                    \nEngine Base NG = %13",
                    _heli getVariable "bmkhs_engPctNG" select 0,
                    _heli getVariable "bmkhs_engPctTQ" select 0,
                    _heli getVariable "bmkhs_engTGT" select 0,
                    _heli getVariable "bmkhs_engPctNG" select 1,
                    _heli getVariable "bmkhs_engPctTQ" select 1,
                    _heli getVariable "bmkhs_engTGT" select 1,
                    _heli getVariable "bmkhs_engState",
                    _heli getVariable "bmkhs_isSingleEng",
                    _heli getVariable "bmkhs_engPctNP",
                    _heli getVariable "bmkhs_engPowerLeverState",
                    bmkhs_collectiveOutput,
                    _heli getVariable "bmkhs_engFF"];
*/
#endif
