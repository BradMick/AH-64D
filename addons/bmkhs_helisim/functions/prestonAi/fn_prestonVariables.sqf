...
_heli setVariable ["bmkhs_pid_prestonPitch",      [0.1200, 0.0200, 0.1000, 5.0000] call fza_fnc_pidCreate];
...
_heli setVariable ["bmkhs_pid_prestonRoll",       [0.0700, 0.0200, 0.0900, 5.0000] call fza_fnc_pidCreate];
...
_heli setVariable ["bmkhs_pid_prestonHoverX",     [0.0600, 0.2200, 0.0500, 0.2500] call fza_fnc_pidCreate];
_heli setVariable ["bmkhs_pid_prestonHoverY",     [0.0700, 0.2500, 0.0600, 0.5500] call fza_fnc_pidCreate];
...
_heli setVariable ["bmkhs_pid_prestonVelX",       [0.0500, 0.0400, 0.1000, 1.0000] call fza_fnc_pidCreate];
_heli setVariable ["bmkhs_pid_prestonVelY",       [0.1000, 0.0200, 0.1200, 1.0000] call fza_fnc_pidCreate];
