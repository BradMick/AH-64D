...
_heli setVariable ["bmkhs_TAS_rngFF",  ([getArray (_config >> "engFFTable"), _TASTable # 4] call fza_fnc_linearInterp select 1) * 2 * 7936.64];

_heli setVariable ["bmkhs_TAS_endTAS", _TASTable # 5];
_heli setVariable ["bmkhs_TAS_endTQ",  _TASTable # 6];
_heli setVariable ["bmkhs_TAS_endFF",  ([getArray (_config >> "engFFTable"), _TASTable # 6] call fza_fnc_linearInterp select 1) * 2 * 7936.64];
