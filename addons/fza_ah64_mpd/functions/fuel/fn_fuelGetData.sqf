...
private _ctrFuelWeight       = _heli getVariable "bmkhs_ctrFuelMass";
private _aftCellWeight       = _heli getVariable "bmkhs_aftFuelMass";

private _stn1FuelWeight      = _heli getVariable "bmkhs_stn1FuelMass";
private _stn2FuelWeight      = _heli getVariable "bmkhs_stn2FuelMass";
private _stn3FuelWeight      = _heli getVariable "bmkhs_stn3FuelMass";
private _stn4FuelWeight      = _heli getVariable "bmkhs_stn4FuelMass";
