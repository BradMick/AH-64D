...
//[_heli, 0, [ 1.2, 4.24,-1.9], 1.35, 0.0, 0.31] call fza_sfmplus_fnc_wheel;
//[_heli, 1, [-1.2, 4.24,-1.9], 1.35, 0.0, 0.31] call fza_sfmplus_fnc_wheel;
//[_heli, 2, [ 0.0,-6.28,-2.4], 1.20, 0.0, 0.16] call fza_sfmplus_fnc_wheel;
[_heli, 0, [ 1.2, 4.24,-1.9], 1.540, 1.440, 10000, 500, 0.33] call fza_sfmplus_fnc_wheel;
[_heli, 1, [-1.2, 4.24,-1.9], 1.540, 1.440, 10000, 500, 0.33] call fza_sfmplus_fnc_wheel;
[_heli, 2, [ 0.0,-6.28,-2.4], 0.470, 0.267, 7000,  500, 0.16] call fza_sfmplus_fnc_wheel;
