...
private _fwdFuelMass = (_totFuelMass / 2) max _maxFwdFuelMass;
private _aftFuelMass = (_totFuelMass - _fwdFuelMass) max _maxAftFuelMass;
private _ctrFuelMass = _totFuelMass - _aftFuelMass;
