...
*/
    ...
    private _fuselageYawTorque = [0.0, 0.0, 1.0] vectorMultiply ((_interpBetaVal * 2500000) * _deltaTime);
...
systemChat format ["Pitch Tq = %1 - Yaw Tq = %2", (_fuselageTorque select 0) toFixed 0, (_fuselageTorque select 2) toFixed 0];
